...
class HresultTest : public ::testing::Test
{
};
TEST_F(HresultTest, ConvertHresult)
{
...
TEST_F(HresultTest, ConvertStandardErrorCode)
{
...
TEST_F(HresultTest, VerifyCustomHResultFailureBitIsSet)
{
...
TEST_F(HresultTest, VerifyCustomHResultCustomerBitIsSet)
{
    auto cameraError = make_error_code(std::errc::broken_pipe);
    auto hresultError = arcana::hr_from_error_code(cameraError);
...
TEST_F(HresultTest, VerifyCustomHResultCategoryIsDifferent)
{
...
TEST_F(HresultTest, VerifyCanGetGenericErrorFromHResult)
{
...
TEST_F(HresultTest, VerifyStandardHResultDoesNotReturnCategory)
{
    auto category = arcana::get_category_from_hresult(E_FAIL);
    EXPECT_TRUE(category == nullptr);
}

TEST_F(HresultTest, VerifyConvertToFromHResult)
{
    auto cameraError = make_error_code(std::errc::broken_pipe);
    auto hresultError = arcana::hr_from_error_code(cameraError);
