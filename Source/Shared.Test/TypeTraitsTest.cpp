...
TEST_F(TypeTraitsTest, UnderlyingCast_WithCStyleEnum_ReturnsCorrectType)
{
...
TEST_F(TypeTraitsTest, UnderlyingCast_WithCStyleEnum_ReturnsCorrectValues)
{
    constexpr auto underlyingValue1 = arcana::underlying_cast(TestCStyleEnum::Value1);
...
TEST_F(TypeTraitsTest, UnderlyingCast_WithEnumClass_ReturnsCorrectType)
{
...
TEST_F(TypeTraitsTest, UnderlyingCast_WithEnumClass_ReturnsCorrectValues)
{
    constexpr auto underlyingValue1 = arcana::underlying_cast(TestEnumClass::Value1);
...
TEST_F(TypeTraitsTest, InvokeOptionalParameter_InvokesTheRightFunction)
{
...
TEST_F(TypeTraitsTest, CountTrueConditionalExpressions)
{
...
TEST_F(TypeTraitsTest, FindFirstTrueConditionalExpressionIndex)
{
