...
class IteratorUnitTest : public ::testing::Test
{
};

TEST_F(IteratorUnitTest, Iterator_WhenStaticForEmpty_NothingIsRun)
{
    int value = 0;
...
TEST_F(IteratorUnitTest, Iterator_WhenStaticFor_NumberOfIterationsIsCorrect)
{
    int iterations = 0;
...
TEST_F(IteratorUnitTest, Iterator_WhenStaticForEachEmpty_NothingIsRun)
{
    int value = 0;
...
TEST_F(IteratorUnitTest, Iterator_WhenStaticForEach_NumberOfIterationsIsCorrect)
{
...
TEST_F(IteratorUnitTest, Iterator_WhenTupleForEachEmpty_NothingIsRun)
{
    int sum = 0;
...
TEST_F(IteratorUnitTest, Iterator_WhenTupleForEach_NumberOfIterationsIsCorrect)
{
