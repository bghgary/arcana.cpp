...
class ExpectedUnitTest : public ::testing::Test
{
protected:
    template<typename E>
...
TEST_F(ExpectedUnitTest, ExpectedCopy)
{
    ExpectedCopyTest<std::error_code>();
    ExpectedCopyTest<std::exception_ptr>();
}

TEST_F(ExpectedUnitTest, ExpectedMove)
{
...
TEST_F(ExpectedUnitTest, VoidExpectedToExceptionalConversion)
{
