...
TEST_F(AlgorithmUnitTest, TestSetOfSubsetsForIntLength0)
{
...
TEST_F(AlgorithmUnitTest, TestSetOfSubsetsForIntLength3)
{
...
TEST_F(AlgorithmUnitTest, TestSetOfSubsetsForCharLength3)
{
...
TEST_F(AlgorithmUnitTest, TestMedianSingleItem)
{
...
TEST_F(AlgorithmUnitTest, TestMedianOddSize)
{
...
TEST_F(AlgorithmUnitTest, TestMedianEvenSize)
{
...
TEST_F(AlgorithmUnitTest, TestMedianEvenSizeSqrtf)
{
...
TEST_F(AlgorithmUnitTest, RangeForStats_MultipleValue_Sum)
{
...
TEST_F(AlgorithmUnitTest, RangeForStats_SingleValue_Sum)
{
    std::vector<duration_t> testVector;
...
TEST_F(AlgorithmUnitTest, RangeForStats_SimilarValues_Mean)
{
    std::vector<duration_t> testVector;
...
TEST_F(AlgorithmUnitTest, RangeForStats_DifferentValues_Mean)
{
    std::vector<duration_t> testVector;
...
TEST_F(AlgorithmUnitTest, RangeForStats_OddSizeCollection_Median)
{
    std::vector<duration_t> testVector;
    testVector.push_back(13ms);
    testVector.push_back(23ms);
...
TEST_F(AlgorithmUnitTest, RangeForStats_EvenSizeCollection_Median)
{
    std::vector<duration_t> testVector;
    testVector.push_back(23ms);
    testVector.push_back(12ms);
...
TEST_F(AlgorithmUnitTest, RangeForStats_SimilarValues_StandardDeviation)
{
    std::vector<duration_t> testVector;
    testVector.push_back(4ms);
    testVector.push_back(4ms);
...
TEST_F(AlgorithmUnitTest, RangeForStats_DifferentValues_StandardDeviation)
{
    std::vector<duration_t> testVector;
    testVector.push_back(13ms);
    testVector.push_back(23ms);
...
TEST_F(AlgorithmUnitTest, PopulationStream_DifferentValues_PopulationStandardDeviation)
{
...
TEST_F(AlgorithmUnitTest, PopulationStream_SameValues_PopulationStandardDeviation)
{
    std::vector<int> testVector;
...
TEST_F(AlgorithmUnitTest, PopulationStream_NegativePositiveValues_PopulationStandardDeviation)
{
    std::vector<int> testVector;
